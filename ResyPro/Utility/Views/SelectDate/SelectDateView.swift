...
extension EnvironmentValues {
  var selectDateViewStyleKey: SelectDateViewStyle {
...
extension View {
    func setSelectDateViewStyleKey(to newStyle: SelectDateViewStyle) -> some View {
        environment(\.selectDateViewStyleKey, newStyle)
    }
}

enum SelectDateViewStyle: Sendable, Equatable {
    case horizontal
    case vertical
}
