...
/// Predefined styles for fonts used in the design system.
...
/// Convenience method to access custom fonts defined for the design system.
extension Font {
  public static func design(_ style: DesignFontStyle) -> Font {
    switch style {
    case .largeTitle:
