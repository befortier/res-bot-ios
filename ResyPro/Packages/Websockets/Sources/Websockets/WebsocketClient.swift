...
/// A lightweight wrapper around ``URLSessionWebSocketTask`` that exposes simple
/// connect, disconnect, authentication and event observation APIs.
public actor WebsocketClient {
    ...
    /// Creates a new ``WebsocketClient`` using the provided ``URLSession``.
